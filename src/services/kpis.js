...
const fetchKPIs = async (req, res, next) => {
  try {
    ...
    const rules = [
      ...
      { section: 'general', collection: 'baskets', filter: { $or: [{ status: 'paid' }, { status: 'delivered' }, { status: 'preparing' }], type: 'veggies' }, id: 'nb_paid_veggies_packs', type: 'count', label: 'pns veggies', model: basketModel },
      ...
      { section: 'week', collection: 'baskets', filter: { $or: [{ status: 'paid' }, { status: 'delivered' }, { status: 'preparing' }], type: 'veggies', createdAt: { $gte: weekMonday, $lte: weekSunday } }, id: 'week_nb_paid_veggies_packs', type: 'count', label: 'pns veggies', model: basketModel },
      ...
      { section: 'month', collection: 'baskets', filter: { $or: [{ status: 'paid' }, { status: 'delivered' }, { status: 'preparing' }], type: 'veggies', createdAt: { $gte: monthFirstDay, $lte: monthLastDay } }, id: 'month_nb_paid_veggies_packs', type: 'count', label: 'pns veggies', model: basketModel },
