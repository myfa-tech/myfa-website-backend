...
const customBasketDetails = {
  ...
  type: 'myfa',
  label: 'Panier MYFA 🙌🏾',
  labelTranslate: 'home_page.baskets.myfa_title',
  active: true,
  homeDesc: 'À vous de le composer !',
  homeDescTranslate: 'home_page.baskets.myfa_home_description',
  imgAlt: 'panier myfa',
  price: 25.99,
  priceCFA: 17000,
  ...
  descriptionTranslate: 'home_page.baskets.myfa_description',
  availableBases,
  availableFruits,
  availableVeggies,
  availableSauces,
